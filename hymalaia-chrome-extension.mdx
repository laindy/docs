...
<img src="/images/chrome-extension.png" className="rounded-xl shadow-md mx-auto" />
...
<img src="/images/plugin-option.png" className="rounded-xl shadow-md mx-auto" />

7. Set the **Root Domain** to your self-hosted Hymalaia instance’s URL.  
<img src="/images/plugin-setting.png" className="rounded-xl shadow-md mx-auto" />
...
<img src="/images/management.png" className="rounded-xl shadow-md mx-auto" />
